...
const READY = ['sprint100','sprint200','sprint400','hurdles110','hurdles400','steeple3000',
               ...
               'run800','run1500','run5000','walk20k','relay4x400','climbSpeed','fencing','decathlon','triathlon','shooting','heptathlon','swimMedley200','tableTennis','judo','vault','canoe','golf','equestrian','highBar','pentathlon'];
...
const G = {
  ...
  classFor(def){
    return def && { sprint100:SprintEvent, sprint200:SprintEvent, sprint400:SprintEvent,
      ...
      swimFree100:SwimEvent, swimBack100:SwimEvent, swimBreast100:SwimEvent, swimFly100:SwimEvent, swimMedley200:SwimEvent, tableTennis:TableTennisEvent, judo:JudoEvent, vault:VaultEvent, canoe:CanoeEvent, golf:GolfEvent, equestrian:EquestrianEvent, highBar:HighBarEvent,
