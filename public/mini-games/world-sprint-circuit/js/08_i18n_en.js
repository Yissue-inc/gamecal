...
const I18N_EN = {
  ...
  '준비 중': 'Coming soon',
  /* 결과 화면 제목(RESULT_TITLE) — 영어 화면에 한국어가 뜨던 자리 */
  '통과':'Qualified',
  '기준기록 미달':'Below standard',
  '시간 초과':'Time out',
  '내 최고 기록!':'Personal best!',
  '선두':'Lead', '내 최고':'My best',
  '%1번 홀  파 %2':'Hole %1  ·  Par %2',
  /* ⛔ 한 글자 키('차'·'회')는 넣지 말 것 — _subst 가 **단어 속 글자까지** 바꾼다.
     조립된 형태를 키로 둔다(K 는 숫자를 %N 으로 정규화한다). */
  '%1 / %2차':'%1 / %2', '%1 / %2회':'%1 / %2', '%1 / %2발':'%1 / %2 shots',
  /* 2026-08-31 — 화면 캡처로 발견한 누락. 검사기가 K(삼항연산자) 안을 못 봤다 */
  '통과 페이스':'On pace',
  '기준 미달':'Off pace',
  '완벽한 발구름!':'Perfect takeoff!',
  '지금 도약!':'Jump now!',
  '지금 발구름!':'Take off now!',
  '액션을 쥐어 힘을 모으세요':'Hold action to build power',
  '지금 놓아!':'Release now!',
  '지금 홉!':'Hop now!',
  '완벽한 꽂기!':'Perfect plant!',
  '지금 꽂아!':'Plant now!',
  '지금 넘겨!':'Hand off now!',
  '지금 턴!':'Turn now!',
  '경고 %1/%2 — 뛰지 마세요':'Warning %1/%2 — no running',
  '미끄러졌다':'slipped',
  '액션: 다시  ·  일시정지: 종목 선택':'Action: retry  ·  Pause: event list',
  '직접 뜁니다 (경험치 %1배)':'You run it (%1× XP)',
  '자동으로 처리합니다':'Simulated automatically',
  '출전 선수 없음':'No athletes entered',
  '몸값보다 후한 제안입니다':'Above market value',
  '적정한 제안입니다':'A fair offer',
  '몸값보다 낮습니다':'Below market value',
  '판매 · 코인 +':'sold · coins +',
  '잠재치에 닿았습니다':'Potential reached',
  ...
  /* ⛔ '%1' 은 **숫자만** 잡는다(_tmpl). 뒤가 글자인 문장은 조각 치환으로 가야 한다 —
     그래서 앞머리를 따로 키로 둔다. 안 그러면 '나 득점 — mistimed it' 처럼 한글이 남고,
     혼종은 미번역으로 취급돼 통째로 한국어가 나간다(2026-08-31 탁구 캡처). */
  '나 득점 — ':'You score — ',
  '상대 득점 — ':'Rival scores — ',
  '1P 득점 — ':'1P scores — ',
  '2P 득점 — ':'2P scores — ',
  '받지 못했다':'could not return it',
  ...
  /* 실패 이유 — 화면이 이미 아는 것을 말해 준다 */
  '좌·우를 번갈아 두드려야 앞으로 갑니다':'Alternate ◀ ▶ to move forward',
  ...
  '내 최고 기록!':'Personal best!',
  '완주':'Finished',
  /* 알파 점검 — 코드에 있던 한국어 리터럴 109개(경기 문구·육성/수집 화면 전체) */
  '사진 판정':'Photo finish',
  '지금 액션! (LEAN)':'Action now! (LEAN)',
  '파울 — 구름판을 넘었다':'Foul — past the board',
  '파울 — 구름판을 지나쳤다':'Foul — overran the board',
  '발구름을 놓쳤다':'Missed the take-off',
  '파울 — 선을 넘었다':'Foul — over the line',
  '파울 — 선을 지나쳤다':'Foul — past the line',
  '같은 쪽!':'Same side!',
  '놓쳤다':'Missed',
  '박스를 지나쳤다':'Overran the box',
  '아직 인계 구역이 아니다':'Not in the exchange zone yet',
  '인계 구역을 놓쳤다 — 실격':'Missed the exchange zone — DQ',
  '늦게 넘길수록 마지막 주자가 덜 뜁니다':'The later you pass, the less the anchor runs',
  '턴을 놓쳤다':'Missed the turn',
  '액션으로 숨쉬기':'Action to breathe',
  '턴 ':'Turn ',
  '기어 ':'Gear ',
  '기준 ':'Standard ',
  '페이스 ↑ ':'Pace ↑ ',
  ...
  '거리 ':'Distance ',
  '지금까지 ':'So far ',
  '공유 카드를 불러오지 못했습니다':'Could not load the share card',
  ...
  '커리어 +':'Career +',
  '다시 호흡 ':'Steady again ',
  '출발 신호를 기다리세요':'Wait for the start signal',
  '번 홀':'Hole',
  '지난주':'Last week',
  '이번 주 성장':'Growth this week',
  '매주 3명까지 직접 지도할 수 있습니다. 나머지는 팀 프로그램대로 훈련합니다.':'You can coach up to three athletes a week. The rest follow the team programme.',
  '직접 지도는 주당 3명까지':'Up to three coached per week',
  '주 종목 ':'Main event ',
  '▲ 무엇이 이 숫자를 만들었나':'▲ What made this number',
  '부상 중인 선수는 출전할 수 없습니다':'Injured athletes cannot compete',
  '적합도는 컨디션까지 반영한 값입니다':'Fit already includes condition',
  '순위':'Rank',
  '▶ 메달 · 보상':'▶ Medals · Rewards',
  '이번 대회에서 얻은 것이 없습니다':'Nothing gained at this meet',
  '아직 후보가 없습니다 — 스카우트를 보내세요':'No prospects yet — send a scout',
  '들어온 제안이 없습니다':'No offers received',
  '잠재 ':'Potential ',
  '더 지켜봐야 합니다':'Needs more watching',
  '제안을 거절했습니다':'Offer declined',
  '보내면 남은 선수 전원 사기 -6':'Selling costs every remaining athlete 6 morale',
  '방출하면 주급이 줄지만 몸값의 25%만 회수됩니다. 되돌릴 수 없습니다.':'Releasing cuts wages but returns only 25% of the value. This cannot be undone.',
  '대회와 훈련으로 포인트가 쌓입니다':'Meets and training earn points',
  '이미 %1의 자질을 물려받았습니다':'Already inherited %1\'s gift',
  '전당이 비어 있습니다':'The hall is empty',
  '합성 → %1':'Combine → %1',
  '같은 등급 3개가 필요합니다':'Needs three of the same grade',
  '%1 습득  (남은 포인트 %2)':'%1 learned  (%2 points left)',
  '%1 장착':'%1 equipped',
  '%1 해제':'%1 removed',
  '슬롯이 %1칸뿐입니다 — 하나를 빼세요':'Only %1 slots — remove one first',
  '%1 잠재치 돌파 → %2  (남은 포인트 %3)':'%1 potential raised → %2  (%3 points left)',
  '벗었습니다':'Removed',
  '컨디션 %1  ·  피로 %2':'Condition %1  ·  Fatigue %2',
  '잠재 +':'Potential +',
  '자동 훈련 보상':'Idle training reward',
  '자리를 비운 동안 선수들이 훈련했습니다':'Your athletes trained while you were away',
  '비운 시간':'Time away',
  '최대 %1시간':'up to %1 h',
  '1명당':'per athlete',
  '코인':'Coins',
  ...
  '훈련 중 %1명':'%1 training',
  '레벨 업':'Level up',
  '훈련 포인트 +%1':'Training points +%1',
  '외 %1명':'and %1 more',
  '레벨은 아직 오르지 않았습니다':'No level up yet',
  '받기':'Claim',
  '받았습니다':'Claimed',
  ...
  '포인트':'Points',
  '주급 %1':'Wage %1',
  '성장 이력 (OVR %1 → %2)':'Growth history (OVR %1 → %2)',
  '보상 받기':'Claim reward',
  '코인과 경험치를 받는다':'Claim coins and XP',
  '코인 +%1 · 경험치 +%2':'Coins +%1 · XP +%2',
  '오늘은 이미 뛰었습니다':'Already run today',
  '%1일 연속':'%1-day streak',
  '오늘의 종목 3개 — 한 번씩만':'Three events today — once each',
  '받을 수 있습니다':'Ready to claim',
  '계승 %1':'Legacy %1',
  '%1의 자질을 물려받았습니다':'Inherited %1\'s gift',
  '%1 이(가) 물려받을 선배를 고르세요':'Choose whose gift %1 inherits',
  '감독 이름':'Manager name',
  '커리어 점수 %1':'Career score %1',
  '코인 +%1 · 전원 훈련 포인트 +%2':'Coins +%1 · Training points +%2 for all',
  '영구 성장  종족당 +0.3%':'Permanent growth  +0.3% per species',
  '1인당':'each',
  '전 종족 등록 완료':'All species recorded',
  '받을 보상 %1건':'%1 rewards to claim',
  '확인 — 받기':'Confirm — claim',
  '%1 %2단계':'%1 tier %2',
  '/분':'/min',
  /* 세이브 손상 안내 */
