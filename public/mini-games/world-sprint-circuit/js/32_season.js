...
const SPEC_OF_KIND = {
  ...
  dive:'jump', tramp:'jump', climb:'jump', gym:'jump',   // 폭발력·기술
  lift:'throw', aim:'throw', shoot:'throw', grap:'throw', golf:'throw',   // 힘·정밀
  cycle:'endure', row:'endure', tri:'endure', slalom:'endure',   // 지구력
  fence:'hurdles', rally:'hurdles', ride:'hurdles',   // 반응·리듬
